// Configuración principal de la aplicación RAG Chat
...
export const appConfig: AppConfig = {
  ...
  bedrock: {
    defaultKnowledgeBaseId: import.meta.env.VITE_DEFAULT_KNOWLEDGE_BASE_ID || 'TJ8IMVJVQW',
  ...
  app: {
    name: import.meta.env.VITE_APP_NAME || 'RAG Chat Application',
    version: import.meta.env.VITE_APP_VERSION || '1.0.0',
    description: import.meta.env.VITE_APP_DESCRIPTION || 'Chat inteligente con AWS Bedrock y Knowledge Base',
  },
  dev: {
